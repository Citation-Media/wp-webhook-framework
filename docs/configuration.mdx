...
See [Notifications](./notifications.mdx) for custom handlers.

## Filter-Based Configuration

Use WordPress filters for dynamic configuration. See [Hooks and Filters](./hooks-and-filters.mdx) for complete reference.
...
See [Failure Handling](./failure-handling.mdx) for configuration.
