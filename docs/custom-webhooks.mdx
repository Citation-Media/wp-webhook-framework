...
description: Create custom webhook implementations using the registry pattern.
sidebar:
  order: 3
---
...
See [Configuration](./configuration.mdx#multiple-endpoints-for-the-same-entity) for a detailed example.
...
See [Webhook Statefulness](./webhook-statefulness.mdx) for details.
