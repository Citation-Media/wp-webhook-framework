...
For email notifications and custom handlers, see [Notifications](./notifications.md).
...
For detailed action documentation, see [Hooks and Filters](./hooks-and-filters.md#actions).
